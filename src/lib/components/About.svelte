  ...
  const highlights = [
    {
      ...
      description:
        "Combining a Business Informatics background with technical expertise to align organizational needs with effective digital solutions",
    },
    {
    ...
    },
    {
      ...
      description:
        "Creating responsive, user-friendly interfaces with React, Next.js, Tailwind CSS, and modern JavaScript/TypeScript tools.",
    },
    {
      title: "Backend Development",
      description:
        "Building scalable APIs and server-side applications with Node.js, Express.js, Python, and database integrations.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Passionate about learning and growing consistently through opportunities to improve, innovate, and build better solutions.",
    },
  ];
</script>
      ...
      <div class="about-intro">
        ...
        <p class="intro-text">
          Passionate about <strong
            >innovation, problem-solving, and continuous growth</strong
          >, I'm always eager to take on challenges that push me to learn more
          and do better. My goal is to create meaningful impact at the
