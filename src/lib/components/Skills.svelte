	...
	const skillCategories = [
		{
			...
			skills: ['Next.js', 'BootStrap', 'Svelte/SvelteKit', 'React', 'TypeScript', 'HTML/CSS', 'Tailwind CSS']
		},
		{
			title: 'Backend Development',
			skills: ['Node.js', 'Python', 'Express.js', 'PostgreSQL', 'MongoDB', 'REST APIs', 'GraphQL', 'MySQL']
		},
		{
